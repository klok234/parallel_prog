...
Были проведены исследования для распараллеливания на 1, 2, 4, 8, 16 вычислительных ядер на суперкомпьютере "Сергей Королёв". Скомпилированная версия на суперкомпьютере `Sergei_Korolev/lab3` для его запуска был также написан скрипт `Sergei_Korolev/startlab3.pbs`.Результаты исследования можно найти в `results/output.txt` и `results/to_plot.txt` по которому были построены графики:
